...
public enum ExpenseSearchOperation {
    ...
    public static ExpenseSearchOperation getDataOption(final String dataOption){
        switch (dataOption){
            case "all": return ALL;
            case "any": return ANY;
            default: return null;
    ...
    public static ExpenseSearchOperation getExpenseSearchOperation(final String input){
